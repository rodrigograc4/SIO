      ...
      <div className="edit-profile-modal">
        ...
        <div className="form-row">
          ...
          <input
            ...
            onChange={(e) => setEditableInfo({ ...editableInfo, morada: e.target.value })}
          />
        </div>
        <div className="form-row">
          <p>Código Postal:</p>
          <input
            ...
            onChange={(e) => setEditableInfo({ ...editableInfo, codigoPostal: e.target.value })}
          />
        </div>
        <div className="form-row">
          <p>Cidade:</p>
          <input
            ...
            onChange={(e) => setEditableInfo({ ...editableInfo, cidade: e.target.value })}
          />
        </div>
        <div className="form-row">
          <p>Contacto:</p>
          <input
            ...
            onChange={(e) => setEditableInfo({ ...editableInfo, contacto: e.target.value })}
          />
        </div>
        <div className="form-row">
